    ...
    return (
        <div className="my-10 sm:my-28 flex flex-col sm:flex-row gap-10 sm:justify-between h-auto sm:h-[27rem] w-full">
            <div className="flex flex-col gap-10 w-full sm:w-[37rem]">
                ...
                <div className="w-full sm:w-[29rem] flex flex-col sm:flex-row gap-3 items-center sm:items-stretch">
                    <a 
                        href="mailto:mvardar97@gmail.com"
                        className="w-full sm:w-auto border rounded-md px-6 py-2 font-Inter font-medium text-lg 
                    ...
                    <a 
                        ...
                        className="w-full sm:w-auto border rounded-md px-6 py-2 text-[#3730A3] font-Inter font-medium text-lg 
